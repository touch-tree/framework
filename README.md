...
> [!NOTE]
> While it's possible, this repository is NOT intended for direct use in a development project. It's recommended that you use this framework alongside our [boilerplate](https://github.com/echtyushi/framework-boilerplate) instead.
